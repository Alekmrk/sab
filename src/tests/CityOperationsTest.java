...
public class CityOperationsTest {
    ...
    public void insertCity_TwoCities_SameName() {
        ...
        int rowId1 = this.cityOperations.insertCity(name, postalCode1);
        int rowId2 = this.cityOperations.insertCity(name, postalCode2);
        Assert.assertEquals(2L, (long)this.cityOperations.getAllCities().size());
